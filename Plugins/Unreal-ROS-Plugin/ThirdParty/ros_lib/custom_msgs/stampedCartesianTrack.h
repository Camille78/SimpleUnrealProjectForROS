#ifndef _ROS_custom_msgs_stampedCartesianTrack_h
#define _ROS_custom_msgs_stampedCartesianTrack_h
...
namespace custom_msgs
{
  ...
  class stampedCartesianTrack : public ros::Msg
  {
    ...
    const char * getType(){ return "custom_msgs/stampedCartesianTrack"; };
